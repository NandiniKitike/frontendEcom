      ...
      <div className="w-full md:p-10 p-4">
        <div className="flex justify-between  mt-[-50px] items-center pb-4">
          ...
          <button
            ...
            className="bg-green-600 text-white px-4 py-2 rounded text-sm hover:bg-green-900 ml-[75%] mb-4"
          >
            Add Category
          </button>
        </div>
                  ...
                  <tr key={cat._id} className="border-t border-gray-500/20">
                    ...
                    <td>
                      <button onClick={() => handleEdit(cat._id)}>
                        <Edit3 className="w-5 h-5 text-green-600 hover:text-blue-800" />
                      </button>
                    </td>
                    <td>
                      <button onClick={() => handleDelete(cat._id)}>
                        <Trash2 className="w-5 h-5 text-green-600 hover:text-blue-800" />
                      </button>
                    </td>
                  </tr>
                ))

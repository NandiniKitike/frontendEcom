  ...
  return (
    <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
              ...
              <div className="absolute top-full left-0 right-0 z-10 mt-1 bg-white border border-gray-300 rounded shadow-lg max-h-60 overflow-y-auto">
                ...
                <div className="p-3 border-t border-gray-200">
                  <button
                    ...
                    className="w-full text-indigo-500 hover:bg-indigo-50 py-2 text-sm rounded"
                  >
                    + Add New Address
                  </button>
                </div>
        ...
        {paymentMethod === "COD" ? (
          <button
            className="w-full py-3 mt-6 cursor-pointer bg-green-500 text-white font-medium  disabled:bg-gray-400 disabled:cursor-not-allowed"
